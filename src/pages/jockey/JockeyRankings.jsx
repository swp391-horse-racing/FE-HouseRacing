...
export function JockeyRankings() {
  ...
  return (
    <JockeyLayout
      ...
      subtitle="Xếp hạng jockey mùa giải 2026"
    >
      ...
      <GlassCard>
        <div className="p-5 border-b border-white/10">
          <h2 className="font-bold text-white">Bảng xếp hạng mùa 2026</h2>
        </div>
            ...
            <tbody>
              {rankings.map((r) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-right text-[#D4A017] font-bold">
                    {r.wins}
                  </td>
                  <td className="px-5 py-4 text-right text-white/70">
                    {r.races}
                  </td>
                  <td className="px-5 py-4 text-right text-emerald-300 font-bold">
                    {r.winRate}%
                  </td>
