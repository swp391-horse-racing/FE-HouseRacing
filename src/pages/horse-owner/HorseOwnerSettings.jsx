...
import { HorseOwnerToggle } from "./components/HorseOwnerToggle";
      ...
      <div className="max-w-2xl space-y-5">
        ...
        <GlassCard>
          <div className="p-5 border-b border-white/10 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/50">Cài đặt bảo mật tài khoản</p>
            </div>
          </div>
          <div className="p-5 space-y-4">
            <HorseOwnerToggle
            ...
            <HorseOwnerToggle
              ...
              desc="Cho phép người khác xem hồ sơ"
        ...
        <GlassCard>
          <div className="p-5 border-b border-white/10 flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-white">Tùy chọn hiển thị</h3>
              <p className="text-xs text-white/50">
          ...
          <div className="p-5 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-white/50">Ngôn ngữ hiển thị</div>
              </div>
              <select
                ...
                className="px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-white text-sm focus:outline-none focus:border-[#D4A017]"
              >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-white/50">Hiển thị số tiền</div>
              </div>
              <select
