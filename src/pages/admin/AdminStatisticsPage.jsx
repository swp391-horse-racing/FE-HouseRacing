...
const topHorses = [
  {
    ...
    owner: "Nguyễn Văn A",
    wins: 12,
    earnings: "850,000,000 đ",
  },
  {
    name: "Black Pearl",
    owner: "Trần Thị B",
    wins: 9,
    earnings: "620,000,000 đ",
  },
  {
    name: "Wind Runner",
    owner: "Lê Văn C",
    wins: 7,
    earnings: "480,000,000 đ",
  },
  {
    name: "Golden Star",
    owner: "Phạm Thị D",
    wins: 6,
    earnings: "410,000,000 đ",
  },
];
              ...
              <div key={item.name}>
                ...
                <div className="h-4 rounded-full bg-white/10">
                  <div
                    ...
                    style={{
                      width: `${(item.registered / maxRegistered) * 100}%`,
                    }}
                  />
                </div>
